            ...
            <ScrollView>
                        ...
                        <View style={{ flexDirection: "row" }}>
                           {
                            ...
                            <View>
                                ...
                                <View style={{ flexDirection: "row" }}>
                                    ...
                                    <Text>{val?.route?.params?.val?.item?.address}</Text>
                                </View>
                            </View>
                        </View>
                    </View>
                ...
                <View style={{ marginLeft: 10, marginRight: 10, height: 150, borderWidth: 1, borderColor: "#f5f5f5", backgroundColor: "white", top: 10 }}>
                    ...
                    <View style={{ top: 20, left: 6 }}>
                        ...
                        <View style={{ flexDirection: "row", justifyContent: "space-evenly" }}>
                            <Text style={{ right: 40, top: 20, alignItems: "center", fontWeight: "500", fontSize: 16, color: "#000" }}>{val?.route?.params?.val?.item?.YearOfEstablishment}</Text>
